...
(STAT), SD detect (insert = 0), and UART0 43/44. Panel+SD SPI at 10 MHz
and 20 MHz ACKed on glass; crate `SPI_MAX_HZ` stays 10 MHz. Still open:
`MicRail` / `SdRail` settle times, GPIO46 pulse.
