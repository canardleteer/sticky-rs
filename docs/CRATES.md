...
| [`panel-view`](../crates/panel-view) | No crates.io trait pairs draw remap, touch remap, enclosure landmarks, and in-plane hold. Board crates implement it; UI talks to the trait. |
