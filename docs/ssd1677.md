...
| Glass part number vs temperature bands | measurement backlog `nyc-panel-glass` | Schematic names analog rails; no glass PN. Toolbox claims **GDEM0397T81P**; not confirmed |
